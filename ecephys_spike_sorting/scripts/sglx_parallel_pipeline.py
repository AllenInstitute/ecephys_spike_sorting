...
run_specs = [									
						['SC024_092319_NP1.0_Midbrain', '0', '0,9', '0', ('cortex', 'medulla') ]
]
...
catGT_dest = r'D:\ecephys_fork\test_data\SC_10trial\SC024_10trial'
...
for spec in run_specs:
    ...
    for i, prb in enumerate(prb_list):
        ...
        if run_CatGT:
            ...
            # Run CatGT
            input_json = os.path.join(json_directory, spec[0] + prb + '_CatGT' + '-input.json')
            output_json = os.path.join(json_directory, spec[0] + prb + '_CatGT' + '-output.json')
            ...
            data_directory = os.path.join(npx_directory, run_folder, prb_folder)
