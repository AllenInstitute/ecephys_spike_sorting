...
npx_directories = {r'J:\764806860_408155_20181017_probeA':npx_params(backup_drive,default_start,default_end),
					r'K:\764806860_408155_20181017_probeB':npx_params(backup_drive,default_start,default_end),
					r'L:\764806860_408155_20181017_probeC':npx_params(backup_drive,default_start,default_end)
					}
		...
		if not busy and current_modules[idx]:
			if info_dict[npx_directory][current_modules[idx]].rcode == None:
				...
				try:
					...
					if p.returncode is not 0 and not(p.returncode is 1 and (current_modules[idx] == 'copy_raw_data' or current_modules[idx] =='copy_processed_data')):
						#failed_dict[npx_directory] = [current_modules[idx],p.returncode]
