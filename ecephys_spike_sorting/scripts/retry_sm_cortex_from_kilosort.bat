ECHO off
title Run sorting using sm_cortex_from_kilosort.py and an input session name
...
ECHO activating environment and starting ecephys_spike_sorting\scripts\sm_cortex_from_kilosort.py
pipenv run python ecephys_spike_sorting\scripts\sm_cortex_from_kilosort.py %session_name%
cmd \k
