...
class processing_session():
    ...
    def __init__(self, session_name, probes_in, probe_type = 'PXI', WSE_computer=None):
        ...
        self.lims_upload_drive = 'E:' #Change to a Sata drive that we don't plan to remove so it stays shared. 
        ...
        pxi_slots['2'] = slot_params(2, os.path.join(r'A:', session_name+'_probeABC'), 'D:', default_backup1, default_backup2)#S
        pxi_slots['3'] = slot_params(3, os.path.join(r'B:', session_name+'_probeDEF'), 'D:', default_backup1, default_backup2)#os.path.join(r'\\sd5\sd5.2', session_name2), os.path.join(r'\\sd5\sd5.2', session_name2))#T
