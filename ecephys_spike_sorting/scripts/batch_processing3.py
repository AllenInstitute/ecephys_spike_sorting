...
npx_directories = {
					#r'J:\774692952_419113_20181107_probeA_1':npx_params(backup_drive,default_start,default_end),
					#r'J:\774692952_419113_20181107_probeA_2':npx_params(backup_drive,default_start,default_end),
					#r'K:\774692952_419113_20181107_probeB_1':npx_params(backup_drive,default_start,default_end),
					#r'K:\774692952_419113_20181107_probeB_2':npx_params(backup_drive,default_start,default_end),
					#r'L:\774692952_419113_20181107_probeC_1':npx_params(backup_drive,default_start,default_end),
					#r'L:\774692952_419113_20181107_probeC_2':npx_params(backup_drive,default_start,default_end),
					#r'J:\770903334_410314_20181031_probeA_1':npx_params(backup_drive,default_start,default_end),
					r'J:\788123130_416856_20181129_probeA':npx_params(backup_drive,default_start,default_end),
					r'K:\788123130_416856_20181129_probeB':npx_params(backup_drive,default_start,default_end),
					r'L:\788123130_416856_20181129_probeC':npx_params(backup_drive,default_start,default_end),
					#r'K:\770233648_410314_20181030_probeB_1':npx_params(backup_drive,default_start,default_end),
					#r'K:\774354879_419113_20181106_probeB_1':npx_params(backup_drive,default_start,default_end),
					#r'L:\770903334_410314_20181031_probeC_1':npx_params(backup_drive,default_start,default_end),
					#r'L:\770233648_410314_20181030_probeC_1':npx_params(backup_drive,default_start,default_end),
					#r'L:\774354879_419113_20181106_probeC_1':npx_params(backup_drive,default_start,default_end),
					#r'J:\770903334_410314_20181031_probeA_2':npx_params(backup_drive,default_start,default_end),
					#r'J:\770233648_410314_20181030_probeA_2':npx_params(backup_drive,default_start,default_end),
					#r'K:\770903334_410314_20181031_probeB_2':npx_params(backup_drive,default_start,default_end),
					#r'K:\770233648_410314_20181030_probeB_2':npx_params(backup_drive,default_start,default_end),
					#r'L:\770903334_410314_20181031_probeC_2':npx_params(backup_drive,default_start,default_end),
					#r'L:\770233648_410314_20181030_probeC_2':npx_params(backup_drive,default_start,default_end),
					#r'L:\774354879_419113_20181106_probeC_2':npx_params(backup_drive,'depth_estimation',default_end)
					}
	...
	for idx, npx_directory in enumerate(npx_directories):
		...
		if not busy and current_modules[idx]:
			if info_dict[npx_directory][current_modules[idx]].rcode == None:
				print("fetching exit status and info for", current_modules[idx], npx_directory)
				try:
					...
					print("finished fetching exit status and info for", current_modules[idx], npx_directory)
					if p.returncode is not 0:
						failed_dict[npx_directory] == 1
						print("return code not 0 for ",  current_modules[idx], npx_directory)
						print("setting ", npx_directory, "status to failed ")
		...
		if (current_modules[idx] == npx_directories[npx_directory].end_module) and info_dict[npx_directory][current_modules[idx]].rcode is not None:	
			finished_list[idx] = 0
			print("Finished processing ", npx_directory)
		if  not(busy) and not(kilosort_wait) and finished_list[idx] and (failed_dict[npx_directory]==0 or next_module == 'copy_processed_data'):
			...
			try:
				...
				#TODO check median subtraction doesn't fail as well? before starting kilosort?
					...
					process_dict[npx_directory].append(subprocess.Popen(command_string, stderr = subprocess.PIPE)) # parallel
