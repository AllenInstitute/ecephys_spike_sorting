...
# directory containing the tPrime executable

sync_period = 1.0   # true for SYNC wave generated by imec basestation
toStream_sync_params = 'SY=0,384,6,500' # copy from the CatGT command line
niStream_sync_params = 'XA=0,1,3,500'   # copy from the CatGT comman line, set to None if no Aux data
...
for spec in run_specs:
    ...
    # after loop over probes, create batch file to run TPrime to create files 
